...
def Energy(circuit, edges, edge_data, compute_state=False):
    """
...
def compute_gradients(params_np, edges, edge_data, n, d):
    ...
    for i in range(num_params):
        ...
        # Compute energy
        energy_plus, _ = Energy(qc_plus, edges, edge_data)
        energy_minus, _ = Energy(qc_minus, edges, edge_data)
...
class QuantumCircuitFunction(torch.autograd.Function):
    @staticmethod
    def forward(ctx, params, edges, edge_data, n, d, compute_state):
        ...
        energy, state = Energy(qc, edges, edge_data, compute_state)
    ...
    def backward(ctx, grad_output, grad_output_state):
        ...
        return grad_output * grad_params, None, None, None, None, None
...
class NN_MERA_Model(torch.nn.Module):
    ...
    def forward(self,edges, edge_data, latent_vector, compute_state=False):
        """
        ...
        energy, state, circuit = QuantumCircuitFunction.apply(params, edges, edge_data, self.n, self.d, compute_state)
